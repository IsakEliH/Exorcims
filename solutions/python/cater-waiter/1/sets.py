...
def categorize_dish(dish_name: str, dish_ingredients: set) -> str:
    ...
    categories_str = ["VEGAN", "VEGETARIAN", "PALEO", "KETO", "OMNIVORE"]

    for index, value in enumerate(categories):
        if dish_ingredients <= value:  # checks if subclass
            return f"{dish_name}: {categories_str[index]}"
